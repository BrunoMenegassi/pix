...
bool CmdSetLightAmbient::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
...
bool CmdSetLightDiffuse::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
...
bool CmdSetLightSpecular::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
...
bool CmdAddDirectionalLight::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
...
bool CmdAddPointLight::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
...
bool CmdAddSpotLight::Execute(const vector<string>& params)
{
	if (params.size() < 3)
	{
		return false;
